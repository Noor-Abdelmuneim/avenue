        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 relative">
            ...
            <div className="absolute -bottom-8 -right-6 bg-white p-6 rounded-xl shadow-lg max-w-xs">
              ...
              <p className="text-sm text-gray-600">
                نهدف إلى بناء مجتمعات سكنية متميزة وتطوير عمراني مبتكر يلبي احتياجات بلدنا.
              </p>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-[#9e1915] hover:bg-[#cd3c37] text-white px-8 py-3 rounded-full">
                تعرف علينا أكثر
                <ArrowLeft className="w-5 h-5 mr-3" />
              </Button>
              <Button
                variant="outline"
                className="border-2 border-[#9e1915] text-[#9e1915] hover:bg-[#9e1915] hover:text-white px-8 py-3 rounded-full"
              >
                تحميل البروفايل
              </Button>
            </div>
